...
namespace NS_CostMap
{
      ...
      : costmap_ (), initialized_ (false), size_locked_ (false)
  {
    ...
    else costmap_.setDefaultValue (0);
  }
  ...
  void
  LayeredCostmap::resizeMap (unsigned int size_x, unsigned int size_y,
  ...
  LayeredCostmap::updateMap (double robot_x, double robot_y, double robot_yaw)
  {
    if (plugins_.size () == 0)
    {
      printf ("There is no layer exist.\n");
      return;
    }
