...
namespace NS_Planner
{
  ...
  public:
    ...
    TrajectoryPlanner(WorldModel& world_model,
                      ...
                      int vtheta_samples = 20, double pdist_scale = 0.6,
                      double gdist_scale = 0.8, double occdist_scale = 0.2,
                      ...
                      bool holonomic_robot = true, double max_vel_x = 0.5,
                      double min_vel_x = 0.1, double max_vel_th = 1.0,
                      double min_vel_th = -1.0,
                      double min_in_place_vel_th = 0.4,
                      double backup_vel = -0.1, bool dwa = false,
     ...
     */
    void
    getLocalGoal(double& x, double& y);
     ...
     */
    bool
    checkTrajectory(double x, double y, double theta, double vx, double vy,
     ...
     */
    double
    scoreTrajectory(double x, double y, double theta, double vx, double vy,
                    double vtheta, double vx_samp, double vy_samp,
                    double vtheta_samp);
  ...
  private:
     ...
     */
    Trajectory
    createTrajectories(double x, double y, double theta, double vx, double vy,
                       double vtheta, double acc_x, double acc_y,
                       double acc_theta);
     ...
     */
    void
    generateTrajectory(double x, double y, double theta, double vx, double vy,
                       double vtheta, double vx_samp, double vy_samp,
     ...
     */
    double
    footprintCost(double x_i, double y_i, double theta_i);
    ...
    double
    headingDiff(int cell_x, int cell_y, double x, double y, double heading);
  };
}
;
