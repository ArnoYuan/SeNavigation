...
namespace NS_Planner
{
  ...
  void OscillationCostFunction::setOscillationResetDist(double dist,
                                                        double angle)
  {
  ...
  void OscillationCostFunction::updateOscillationFlags(
      Eigen::Vector3f pos, NS_Planner::Trajectory* traj, double min_vel_trans)
  {
    if(traj->cost_ >= 0)
    {
      ...
      const Eigen::Vector3f& pos, const Eigen::Vector3f& prev)
  {
    ...
    if(sq_dist > oscillation_reset_dist_ * oscillation_reset_dist_ || fabs(
  ...
  bool OscillationCostFunction::setOscillationFlags(NS_Planner::Trajectory* t,
  ...
  {
    if((forward_pos_only_ && traj.xv_ < 0.0) || (forward_neg_only_ && traj.xv_ > 0.0) || (strafe_pos_only_ && traj.yv_ < 0.0) || (strafe_neg_only_ && traj.yv_ > 0.0) || (rot_pos_only_ && traj.thetav_ < 0.0) || (rot_neg_only_ && traj.thetav_ > 0.0))
    {
      return -5.0;
    }
    return 0.0;
